...
defmodule Fera.Connection do
  @moduledoc """
  Handle Tesla connections for Fera.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, Fera.Connection,
        base_url: "https://api.fera.ai/v3/private",
  ...
  @default_base_url Application.compile_env(
                      :fera,
                      :base_url,
                      "https://api.fera.ai/v3/private"
                    )

  @default_scopes [
    # Ability to write to the account.
    "write",
    # Ability to read data from the account.
    "read"
  ]
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:fera, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - Fera 3.14.1 - elixir"
        )
      )
